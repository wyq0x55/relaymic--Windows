...
### T6 落地页 —— 已完成，见 `site/`（2026-08-17）
- 英文主站 + 隐私/条款页，Cloudflare Workers（静态资源 + `/api/subscribe` 写 D1）
- 收邮箱而非预售：支付账户还没有，先测转化率，测支付意愿要另换 CTA
- 部署步骤、上线前待办、投流归因用法全在 `site/README.md`
- **未部署**：需要作者跑 `wrangler login` + `d1 create` 并接上自定义域
