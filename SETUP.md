...
5. **Roughly how much latency** — network round trip plus a 150 ms buffer, close to a phone call.
   Fine for talking, dictation and meetings; **not** for monitoring yourself while recording
6. **Privacy** — the audio goes over an encrypted peer-to-peer connection and doesn't touch a
